...
TopDownGame.Game.prototype = {
  ...
  showLabels: function() {
    ...
    this.atkLabel = this.game.add.text(this.game.width - 50, this.game.height - 40, "攻：999", textStyle);
    this.defLabel = this.game.add.text(this.game.width - 50, this.game.height - 30, "防：999", textStyle);
    this.hpLabel = this.game.add.text(this.game.width - 50, this.game.height - 20, "血：999", textStyle);
    this.atkLabel.fixedToCamera = true;
    this.defLabel.fixedToCamera = true;
